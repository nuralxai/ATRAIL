...
export default function UserDashboard() {
  ...
  return (
    <AppShell
      title="My Dashboard"
      subtitle="Track your work and submit proof for review."
    >
      {/* Top Stats Row */}
      <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-6">
        <Card>
          <CardContent className="p-5 flex items-center gap-4">
            ...
            <div>
              <p className="text-xs text-text-muted font-medium tracking-wide">ASSIGNED PROJS</p>
        ...
        <Card>
          <CardContent className="p-5 flex items-center gap-4">
            ...
            <div>
              <p className="text-xs text-text-muted font-medium tracking-wide">COMPLETED</p>
              {loading ? <Skeleton className="h-6 w-16 mt-1" /> : <p className="text-2xl font-bold text-white">{submittedTasks}</p>}
            </div>
          </CardContent>
        </Card>
        ...
        <Card className="md:col-span-2 border-primary/20 bg-primary/5 flex flex-col justify-between">
          ...
          <CardContent>
            <div className="grid grid-cols-3 gap-4">
              ...
              >
                <div className="text-sm font-bold uppercase tracking-wider text-primary group-hover:text-primary-light">Attendance</div>
                <div className="text-xs text-text-muted">Mark punches</div>
              </Link>
              ...
              >
                ...
                <div className="text-xs text-text-muted">View / Update</div>
              </Link>
              ...
              >
                ...
                <div className="text-xs text-text-muted">Team messages</div>
              </Link>
            </div>
          </CardContent>
        </Card>
